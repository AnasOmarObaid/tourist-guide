<header class="app-header"><a class="app-header__logo" href="index.html">Tourist Guide</a>
      ...
      <ul class="app-nav">
            ...
            <li class="dropdown direction-left"><a class="app-nav__item" href="#" data-bs-toggle="dropdown"
                  ...
                  <ul class="dropdown-menu settings-menu dropdown-menu-right">
                        <li><a class="dropdown-item" href="{{ route('dashboard.setting.index') }}"><i class="bi bi-gear me-2 fs-5"></i>
                                    Settings</a></li>
                        <li><a class="dropdown-item" href="{{ route('dashboard.profile.edit') }}"><i class="bi bi-person me-2 fs-5"></i>
                                   Profile</a></li>
                        <li>
