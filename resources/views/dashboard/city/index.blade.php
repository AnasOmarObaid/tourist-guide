                ...
                <div class="tile cu-rounded">
                    <div class="tile-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('dashboard.city.create') }}" class="btn btn-primary cu-rounded">
                                    ...
                                    <div class="card h-100 cu-rounded" id="city-{{ $city->id }}">
                                        ...
                                        <div class="card-body">
                                            <div class="info d-flex justify-content-between mb-1"
                                                ...
                                                <small class="card-title">{{ $city->formatted_created_at }}</small>
                                            </div>
                                            @if ($city->status)
                                            ...
                                            <div class="card-tail mt-3">
                                                <a href="#" class="btn btn-primary d-block w-100 cu-rounded"><i
