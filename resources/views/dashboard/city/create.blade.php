      ...
      <main class="app-content">
            <div class="app-title">
                  ...
                  <ul class="app-breadcrumb breadcrumb">
                        ...
                        <li class="breadcrumb-item">Create City</li>
                  </ul>
            </div>
            <div class="row">
                  ...
                  <div class="row mb-4">
                        ...
                        <div class="col-12 col-lg-6">
                              <div class="tile cu-rounded">
                                    <div class="tile-body">
                                          <form class="form" method="POST" action="{{ route('dashboard.city.store') }}"
                                                ...
                                                <div class="tile-footer text-center">
                                                    <button class="btn btn-primary cu-rounded w-100 mb-0" type="submit">
                                                        <i class="bi bi-check-circle-fill"></i>Create City
                                                    </button>
                                                </div>
                                          </form>
                                    </div>
                        ...
                        <div class="col">
                              {{-- city card --}}
                              <div class="card h-70 cu-rounded">
                                    <div class="card-img-container cu-rounded">
                                          <img id="previewImage" src="{{ asset('https://placehold.co/350x350/') }}"
                                                class="card-img-top cu-rounded" alt="Random" />
                                    </div>
                                    <div class="card-body">
                                          <div class="info mb-1"
                                                style="align-items: baseline;">
                                                <h5 class="card-title d-inline" id="name_preview">{{ old('name') }}</h5>
                                                , <h5 class="card-title d-inline" id="country_preview">{{ old('country') }}</small>
                                          </div>
                                        <span class="badge bg-success cu-rounded" id="previewStatus">{{ old('status', 'Available') ? 'Available' : '' }}</span>
                                          <p class="card-text mt-2" id="description_preview"></p>
                                          <div class="card-tail">
                                                <p class="card-text d-inline" id="latitude_preview"></p>
                                                <p class="card-text d-inline" id="longitude_preview"></p>
                                          </div>
                                    </div>
                              </div>
                        </div>
